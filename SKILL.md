...
| `references/signal_classification.md` | **定时扫盘/批量决策时必须加载**；用户询问"明天怎么办"、"该不该卖"、"能不能买"等批量决策，或询问精确入场/卖出信号判定、回调结束确认、诱空陷阱、中继突破、恐慌反包等 | 三信号框架(❌💰🟡)、卖出9条件(S1-S9)、入场8信号(E1-E8含E5缩量回调/E6回抽/E7诱空/E8形态突破)、天量以换手率>10%为准、ETF不适用天量 |
